...
Name:		squidanalyzer
Version:	32b8607e617febf7b831834159d3105543e4c4ad
Release:	1
License:	GPLv3
Group:		Monitoring
URL:		http://%{name}.darold.net/
Source:		https://github.com/darold/%{name}/archive/%{version}.zip
BuildRequires:	perl
BuildArch:	noarch
...
%config(noreplace) %attr(0754,root,root) %{_sysconfdir}/cron.d/%{name}
