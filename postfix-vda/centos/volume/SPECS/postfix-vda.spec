...
Name: postfix
Summary: Postfix Mail Transport Agent with VDA patch
Version: 2.10.1
Release: 6.0.1.vda%{?dist}
Epoch: 2
...
%changelog
* Wed Jun 10 2015 Pavel Podkorytov <pod.pavel@gmail.com> - 2:2.10.1-6.vda.el7.centos
- add vda patch (http://vda.sourceforge.net/)
- add .vda to release

* Fri Dec  5 2014 Johnny Hughes <johnny@centos.org> - 2:2.10.1-6.el7.centos
- add pgsql support
